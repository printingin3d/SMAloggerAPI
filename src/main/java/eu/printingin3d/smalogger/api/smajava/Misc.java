...
public final class Misc {
    ...
    public static final int NAN_S32 = (int) 0x80000000L; // "Not a Number" representation for LONG (converted to 0)
    public static final int NAN_U32 = (int) 0xFFFFFFFFL; // "Not a Number" representation for ULONG (converted to 0)
    public static final long NAN_S64 = 0x8000000000000000L; // "Not a Number" representation for LONGLONG 
                                                            // (converted to 0)
    public static final long NAN_U64 = 0xFFFFFFFFFFFFFFFFL; // "Not a Number" representation for ULONGLONG 
                                                            // (converted to 0)
